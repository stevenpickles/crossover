...
pub struct DrawnMonitor {
    ...
    /// measurement: it was seeded, and the machine could not say how big
    /// the panel physically is ([`crate::seeding::SeededSize::estimated`]).
    ///
    ...
    /// platform knows about the panel today.
